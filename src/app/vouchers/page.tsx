...
import { FileText, Plus, AlertCircle, CheckCircle2, Printer, Download } from "lucide-react";
...
export default function VouchersPage() {
  ...
  useEffect(() => {
    if (showForm && printAreaRef.current) {
      printAreaRef.current.scrollTop = 0;
    }
  }, [showForm]);
      ...
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="flex items-center gap-4 p-4 rounded-2xl"
          ...
          <div>
            <p className="text-sm font-medium" style={{ color: "#f59e0b" }}>
              พบรายการที่ไม่มีใบเสร็จ 3 รายการ
            </p>
            <p className="text-xs mt-0.5" style={{ color: "var(--muted-foreground)" }}>
              กรุณาออกใบรับรองแทนใบเสร็จสำหรับรายการเหล่านี้
            </p>
          </div>
        </div>
        ...
        <div className="rounded-2xl overflow-hidden"
          ...
          <div className="p-4 border-b" style={{ borderColor: "var(--card-border)" }}>
            <h2 className="font-medium" style={{ color: "var(--foreground)" }}>รายการที่รอใบรับรองแทน</h2>
          </div>
          <div className="divide-y" style={{ borderColor: "var(--card-border)" }}>
            {[
              ...
              <div key={item.id} className="flex items-center gap-4 p-4">
                ...
                <button
                  onClick={() => {
                    setForm({ ...form, paidTo: item.requester, amount: item.amount, purpose: item.desc, date: item.date });
                    setShowForm(true);
                  }}
        ...
        {/* Form Modal — rendered via portal to escape overflow:hidden on parent containers */}
              ...
              <div id="voucher-print" ref={printAreaRef} className="p-5 sm:p-8 overflow-y-auto flex-1"
                ...
                <div className="mb-6 text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="border-b border-gray-300 flex-1 py-1 outline-none font-bold text-lg"
                      placeholder="0.00"
                    />
                ...
                <div className="mb-8 text-sm">
                  ...
                  <textarea
                    ...
                    className="border-b border-gray-300 w-full py-1 outline-none resize-none"
                    rows={2}
